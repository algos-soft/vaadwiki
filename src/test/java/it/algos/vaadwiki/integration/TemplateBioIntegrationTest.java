...
//        uploadBio();
    ...
    private void fixSesso() {
        ...
        stampaParInterrogativoNo(ParBio.sesso);
    }// end of single test
    ...
    private void fixLuogoNascita() {
        ...
        stampaParInterrogativoSi(ParBio.luogoNascita);
    }// end of single test
    ...
    private void fixLuogoMorte() {
        ...
        stampaParInterrogativoSi(ParBio.luogoMorte);
    }// end of single test
    ...
    private void stampaPar(ParBio par, String sorgente, String previsto) {
        ...
        System.out.println(sorgente + " diventa: " + troncato + "(troncato) - " + valore + "(valore) - " + parametro + "(parametro) - " + finale + "(finale) ");
    }// end of method
