...
public class QueryOneroseTest extends WTest {
    ...
    @Test
    @Order(1)
    @DisplayName("1 - Legge tutti i pageIds della categoria BioBot (per intero)")
    void queryCat() {
    ...
    @Test
    @Order(2)
    @DisplayName("2 - Legge i MiniWrap (timestamp) dai pageIds della categoria BioBot")
    void queryTimestamp() {
    ...
    @Test
    @Order(3)
    @DisplayName("3 - Legge i WrapBio dai pageIds (elaborati) della categoria BioBot")
    void queryPages() {
