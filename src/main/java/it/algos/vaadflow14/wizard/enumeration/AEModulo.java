...
public enum AEModulo {
    ...
    dirDirApplication("Application", "Directory application del modulo target", true, false, AEWizCost.dirApplication.get()),
    dirDirBoot("Boot", "Directory boot del modulo target", true, false, AEWizCost.dirBoot.get()),
    dirDirBackEnum("Enumeration", "Directory backend/enumeration del modulo target", true, false, AEWizCost.dirBackEnum.get()),
    dirDirData("Data", "Directory data del modulo target", true, false, AEWizCost.dirData.get()),
    dirDirPackages("Packages", "Directory packages del modulo target", true, false, AEWizCost.dirPackages.get()),
    dirUI("UI", "Directory UI del modulo target", true, false, AEWizCost.dirUI.get()),
    dirDirUiEnum("Enumeration", "Directory ui/enumeration del modulo target", true, false, AEWizCost.dirUiEnum.get()),
