...
public class ContinenteLogicList extends LogicList {
     ...
     */
    public ContinenteLogicList(@Autowired @Qualifier("continenteService") final AIService entityService) {
        super(entityService, Continente.class);
