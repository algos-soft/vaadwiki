...
@AIEntity(recordName = "Provincia", keyPropertyName = "nome", usaKeyIdMinuscolaCaseInsensitive = true, usaBoot = true, usaNew = false)
...
public class Provincia extends AREntity {
