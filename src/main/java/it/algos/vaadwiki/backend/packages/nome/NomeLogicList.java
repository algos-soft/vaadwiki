...
public class NomeLogicList extends LogicList {
     ...
     *
     * @param nomeService (@Autowired) (@Qualifier) riferimento al service specifico correlato a questa istanza (prototype) di LogicList
     */
    public NomeLogicList(@Autowired @Qualifier("nomeService") final AIService nomeService) {
        super(nomeService, Nome.class);
