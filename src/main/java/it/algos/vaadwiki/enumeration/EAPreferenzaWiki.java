...
public enum EAPreferenzaWiki implements IAPreferenza {
    ...
    lastUploadStatisticheAttivita(LAST_UPLOAD_STATISTICHE_ATTIVITA, "Ultimo upload delle pagine di statistiche delle attività", EAPrefType.date, null),
    lastUploadStatisticheNazionalita(LAST_UPLOAD_STATISTICHE_NAZIONALITA, "Ultimo upload delle pagine di statistiche delle nazionalità", EAPrefType.date, null),
    lastUploadStatisticheNomi(LAST_UPLOAD_STATISTICHE_NOMI, "Ultimo upload delle pagine di statistiche dei nomi", EAPrefType.date, null),
    lastUploadStatistiche(LAST_UPLOAD_STATISTICHE_COGNOMI, "Ultimo upload delle pagine di statistiche dei cognomi", EAPrefType.date, null),
    ...
    durataUploadStatisticheNomi(DURATA_UPLOAD_STATISTICHE_NOMI, "Durata in secondi dell'ultimo upload delle pagine di statistiche dei nomi", EAPrefType.integer, 0L),
    durataUploadStatisticheCognomi(DURATA_UPLOAD_STATISTICHE_COGNOMI, "Durata in secondi dell'ultimo upload delle pagine di statistiche dei cognomi", EAPrefType.integer, 0L),
