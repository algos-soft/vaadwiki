...
public class GenereList extends WikiList {
    ...
    protected void fixPreferenze() {
        ...
        super.flagDaemon = USA_DAEMON_GENERE_DOWNLOAD;
    ...
    protected void creaAlertLayout() {
        ...
        alertPlacehorder.add(text.getLabelAdmin("Modulo:Bio/Plurale attività genere."));
        ...
        alertPlacehorder.add(text.getLabelDev("Indipendentemente da come sono scritte nel modulo wiki, tutte le attività singolari e plurali sono convertite in minuscolo."));
    }// end of method
