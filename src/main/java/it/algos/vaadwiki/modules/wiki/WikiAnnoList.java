...
public class WikiAnnoList extends WikiList {
    ...
    protected void creaAlertLayout() {
        ...
        alertPlacehorder.add(text.getLabelAdmin(" Progetto:Biografie/Anni"));
        alertPlacehorder.add(text.getLabelAdmin("Sovrascrive il modulo 'Anno' di vaadflow. Contiene i 1.000 anni A.C. ed i 2020 (estensibile) D.C.. Non modificabili."));
