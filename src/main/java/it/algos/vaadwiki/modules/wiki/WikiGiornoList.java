...
public class WikiGiornoList extends WikiList {
    ...
    protected void creaAlertLayout() {
        ...
        alertPlacehorder.add(text.getLabelAdmin(" Progetto:Biografie/Giorni"));
        alertPlacehorder.add(text.getLabelAdmin("Sovrascrive il modulo 'Giorno' di vaadflow. Contiene i 366 giorni dell'anno (29 febbraio compreso). Non modificabili."));
